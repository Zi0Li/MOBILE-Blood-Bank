class Requirements {
  ...
  static List<String> definitive = [
    'Pessoas que contraíram Hepatite viral(tipo A) após os 11 anos de idade deve ser avaliado pelo médico da triagem.',
    'Evidencia clinica ou laboratorial das seguintes doenças infecciosas transmissíveis pelo sangue : Hepatites B e C / AIDS ( vírus HIV) / Doenças associadas aos vírus HTLV I e II / Doença de chagas;',
    'Uso de drogas ilícitas injetáveis.',
    'Se diagnóstico prévio de Malária.',
  ];
}
